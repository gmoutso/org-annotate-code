...
(defcustom org-annotate-projects-root "~/workspace/moutsopoulosg"
  "Root of project")
...
(defun org-annotate-projects-info-at-point (wspfolder)
...
(defun org-annotate-projects-capture-finding-location ()
  ...
  (let ((org-annotate-code-org-file (concat org-annotate-projects-root "/" org-annotate-projects-org-file))
